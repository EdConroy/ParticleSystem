...
{
    value = __min( max, value + step );
}

template< typename T >
void Decrement( T& value, const T& step, const T& min )
{
    value = __max( min, value - step );
}
    ...
    case '-':
        {
            ...
            g_ParticleEmitter.MaximumRadius = __max( 0.0f, g_ParticleEmitter.MaximumRadius );
            g_ParticleEmitter.MaximumRadius = __max( 0.0f, g_ParticleEmitter.MaximumRadius );
        }
        break;
    case '+':
        {
            ...
            g_ParticleEmitter.MaximumRadius = __min( 200.0f, g_ParticleEmitter.MaximumRadius );
            g_ParticleEmitter.MaximumRadius = __min( 200.0f, g_ParticleEmitter.MaximumRadius );
        }
        break;
    case 's':
